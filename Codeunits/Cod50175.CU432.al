...
//     LOCAL PROCEDURE CreateSubsidGLEntry(FromEntry: Record 17; VAR ToEntry: Record 17);
//     VAR
//         ParentCompanyOriginalEntry: Record 17;
//         VendLedgEntry: Record 25;
//         CreateVendLedgEntry: Record 25;
//         TempToVendLedgEntry: Record 25 TEMPORARY;
//         Found: Boolean;
//     BEGIN
//         //>>CIS.RAM
//         TempToVendLedgEntry.RESET;
//         TempToVendLedgEntry.DELETEALL;
//         ParentCompanyOriginalEntry.RESET;
//         BusUnit.GET('NICA');
//         ParentCompanyOriginalEntry.CHANGECOMPANY(BusUnit."Company Name");
//         ParentCompanyOriginalEntry.GET(FromEntry."Entry No.");
...
//         VendLedgEntry.SETRANGE("Document No.", ParentCompanyOriginalEntry."Document No.");
//         VendLedgEntry.SETRANGE("Document Type", VendLedgEntry."Document Type"::Payment);
//         VendLedgEntry.SETRANGE("Posting Date", ParentCompanyOriginalEntry."Posting Date");
//         IF VendLedgEntry.FINDFIRST THEN
//             REPEAT
//                 CreateVendLedgEntry.RESET;
//                 CreateVendLedgEntry.CHANGECOMPANY(BusUnit."Company Name");

//                 IF VendLedgEntry."Entry No." <> 0 THEN BEGIN
//                     CreateVendLedgEntry := VendLedgEntry;

//                     FindApplnEntriesDtldtLedgEntry(CreateVendLedgEntry);
//                     CreateVendLedgEntry.SETCURRENTKEY("Entry No.");
//                     CreateVendLedgEntry.SETRANGE("Entry No.");

//                     IF CreateVendLedgEntry."Closed by Entry No." <> 0 THEN BEGIN
//                         CreateVendLedgEntry."Entry No." := CreateVendLedgEntry."Closed by Entry No.";
//                         CreateVendLedgEntry.MARK(TRUE);
//                         TempToVendLedgEntry := CreateVendLedgEntry;
//                         TempToVendLedgEntry.INSERT;
//                     END;

//                     CreateVendLedgEntry.SETCURRENTKEY("Closed by Entry No.");
//                     CreateVendLedgEntry.SETRANGE("Closed by Entry No.", CreateVendLedgEntry."Entry No.");
//                     IF CreateVendLedgEntry.FIND('-') THEN
//                         REPEAT
//                             CreateVendLedgEntry.MARK(TRUE);
//                             TempToVendLedgEntry := CreateVendLedgEntry;
...
//                     CreateVendLedgEntry.SETCURRENTKEY("Entry No.");
//                     CreateVendLedgEntry.SETRANGE("Closed by Entry No.");
//                     TempToVendLedgEntry.SETCURRENTKEY("Entry No.");
//                     TempToVendLedgEntry.SETRANGE("Closed by Entry No.");
//                 END;

//                 CreateVendLedgEntry.MARKEDONLY(TRUE);
//             UNTIL VendLedgEntry.NEXT = 0;
...
//         ToEntry.RESET;
//         Found := FALSE;
//         //IF FromEntry."Entry No." IN 15591401 THEN BEGIN
//         IF TempToVendLedgEntry.FINDSET THEN
//             REPEAT
//                 IF (TempToVendLedgEntry."Document Type" IN [TempToVendLedgEntry."Document Type"::Invoice, TempToVendLedgEntry."Document Type"::"Credit Memo"]) AND
//                    (ABS(TempToVendLedgEntry."Closed by Amount") = ABS(FromEntry.Amount))
//                 THEN BEGIN
//                     ParentCompanyOriginalEntry.SETRANGE("Document No.", TempToVendLedgEntry."Document No.");
//                     IF TempToVendLedgEntry."Document Type" = TempToVendLedgEntry."Document Type"::Invoice THEN
//                         ParentCompanyOriginalEntry.SETRANGE("Document Type", ParentCompanyOriginalEntry."Document Type"::Invoice)
//                     ELSE
//                         ParentCompanyOriginalEntry.SETRANGE("Document Type", ParentCompanyOriginalEntry."Document Type"::"Credit Memo");
//                     ParentCompanyOriginalEntry.SETRANGE("Posting Date", TempToVendLedgEntry."Posting Date");
//                     ParentCompanyOriginalEntry.SETRANGE("G/L Account No.", PurchaseSetup."AP Trade Account");
//                     ParentCompanyOriginalEntry.FINDSET;
//                     ToEntry := ParentCompanyOriginalEntry;
//                     ToEntry.INSERT;
//                     Found := TRUE;
//                 END;
//             UNTIL (TempToVendLedgEntry.NEXT = 0) OR (Found);
//         //IF NOT Found THEN
//         //  ERROR('Missing Vend Ledg for G/L Entry %1\%2\%3\%4',FromEntry."Entry No.",TempToVendLedgEntry.Amount,FromEntry.Amount,TempToVendLedgEntry."Amount (LCY)");
//         // {
//         // END ELSE
//         // IF CreateVendLedgEntry.FINDFIRST THEN BEGIN
//         //   ParentCompanyOriginalEntry.RESET;
//         //   ParentCompanyOriginalEntry.CHANGECOMPANY(BusUnit."Company Name");
//         //   ToEntry.RESET;
//         //   ToEntry.CHANGECOMPANY(BusUnit."Company Name");
//         //   REPEAT
//         //     //Find GL Entries and update ToEntry and return
//         //     IF CreateVendLedgEntry."Document Type" = CreateVendLedgEntry."Document Type"::Invoice THEN BEGIN
//         //       //MESSAGE('1: %1\%2\%3',CreateVendLedgEntry.COUNT,CreateVendLedgEntry."Entry No.",CreateVendLedgEntry."Vendor No.",CreateVendLedgEntry."Document No.");
//         //       ParentCompanyOriginalEntry.SETRANGE("Document No.",CreateVendLedgEntry."Document No.");
//         //       ParentCompanyOriginalEntry.SETRANGE("Document Type",ParentCompanyOriginalEntry."Document Type"::Invoice);
//         //       ParentCompanyOriginalEntry.SETRANGE("Posting Date",CreateVendLedgEntry."Posting Date");
//         //       ParentCompanyOriginalEntry.SETRANGE("G/L Account No.",PurchaseSetup."AP Trade Account");
//         //       ParentCompanyOriginalEntry.FINDSET;
//         //       ToEntry := ParentCompanyOriginalEntry;
//         //       ToEntry.INSERT;
