codeunit 50003 "Process EDI XML File JRR-1"
{
    ...
    trigger OnRun()
    begin
        pString := 'SALESORDER'; //UPPERCASE(Rec."Parameter String");
        ProcessAll(FALSE);
    end;
    ...
    var
        ...
        Window: Dialog;
        ToEmail: Label 'rosenberger@nifast.com; muraoka.s@nifast.com';
        ...
        To_NRome: Label 'Butts.a@nifast.com';
        To_NUSA: Label 'pavlov.a@nifast.com;leonido.m@nifast.com;Brahmbhatt.k@nifast.com;fassett.t@nifast.com;muraoka.s@nifast.com';
