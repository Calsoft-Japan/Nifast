codeunit 50006 "IoT Process Data"
{
                                            ...
                                            WhseRequest.Type::Outbound:
                                                BEGIN
                                                    ...
                                                    REPEAT
                                                        ...
                                                        IF TransLine.Quantity <> (TransLine."Units per Parcel" * IoTDataStagingMR.Quantity) THEN
                                    ...
                                    IF WhseRequest.FINDSET() THEN
                                        REPEAT
                                            ...
                                            IF WhseActivHeader."No." <> '' THEN
                                                IF WhseRequest."Source Document" = WhseRequest."Source Document"::"Sales Order" THEN BEGIN
    ...
    begin
        ...
        IF NOT IoTDataStagingL.IsEmpty() THEN
            EXIT(FALSE);
        EXIT(TRUE);
    end;
