codeunit 50010 "Exchange Contract Management"
{
        ...
        IF PurchInvoiceSumLine.FIND('-') THEN BEGIN // do we have any lines to post
            REPEAT
                IF PurchInvoiceSumLine."Item No." = '' THEN BEGIN // do we have manually entered value in PO code ?
                    ...
                    IF PurchHeader.FIND('-') THEN // can we find a PO to post
    ...
    //         REPEAT
    //             IF PurchLine."No." = PurchInvoiceSumLine."Customer No." THEN  // this is the line we want to post
    ...
    begin
        ...
        IF TPurchLine.FIND('-') THEN
            IF TPurchLine.NEXT() = 0 THEN  // means we only have 1 match !
                PostLine(TPurchLine)
            ELSE
                ManWarning := TRUE;
    end;
    ...
    begin
      //  ERROR('Not Working');//TODO  //NG-N
        ...
        IF PurchLine2.FIND('-') THEN
            REPEAT
                IF PurchLine2."No." = PurchInvoiceSumLine."Customer No." THEN  // this is the line we want to post
