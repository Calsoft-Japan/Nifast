codeunit 50031 ConsolidationImp
{
    ...
    trigger OnRun()
    begin
        IF CheckToRunConsolidation THEN BEGIN
    ...
    var
        ...
        "DocumentNo.": Code[20];
        ErrorExist: Boolean;
        LastRecordPriorty: Integer;
        AppendDate: Text[30];
        Text101: Label 'No. Series is not assigned in Koppers Setup';
        ...
        MonthFirstDate: Date;
        Text50000: Label 'Posting date is not with in the Month.';
        IsExit: Boolean;
