codeunit 50097 "Get Next License Object No."
{
    ...
    begin
        ...
        CASE StrMenu_lInt OF
            1:
                TypeLicPermission_gRec."Object Type" := TypeLicPermission_gRec."Object Type"::TableData;
            2:
                TypeLicPermission_gRec."Object Type" := TypeLicPermission_gRec."Object Type"::Page;
            3:
                TypeLicPermission_gRec."Object Type" := TypeLicPermission_gRec."Object Type"::Report;
            4:
                TypeLicPermission_gRec."Object Type" := TypeLicPermission_gRec."Object Type"::Codeunit;
            5:
                TypeLicPermission_gRec."Object Type" := TypeLicPermission_gRec."Object Type"::XMLport;
            ELSE
