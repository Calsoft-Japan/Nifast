codeunit 50099 "Init Report Selection"
{
    ...
    begin
        ...
        InsertRepSelection(ReportSelections.Usage::"S.Quote", '1', REPORT::"Sales Quote NA");
        ...
        InsertRepSelection(ReportSelections.Usage::"S.Invoice", '1', REPORT::"Sales Invoice NA");
        ...
        InsertRepSelection(ReportSelections.Usage::"S.Cr.Memo", '1', REPORT::"Sales Credit Memo NA");
        InsertRepSelection(ReportSelections.Usage::"S.Shipment", '1', REPORT::"Sales Shipment NA");
        ...
        InsertRepSelection(ReportSelections.Usage::"P.Cr.Memo", '1', REPORT::"Purchase Credit Memo NA");
        InsertRepSelection(ReportSelections.Usage::"P.Receipt", '1', REPORT::"Purchase Receipt NA");
        ...
        InsertRepSelection(ReportSelections.Usage::"P.Asm.Order", '1', REPORT::"Posted Assembly Order");
        ...
        InsertRepSelection(ReportSelections.Usage::"P.Arch.Return", '1', REPORT::"Arch.Purch. Return Order");
        InsertRepSelection(ReportSelections.Usage::"S.Arch.Return", '1', REPORT::"Arch. Sales Return Order");
    ...
    begin
        ...
        InsertRepSelection(ReportSelections.Usage::Inv2, '1', REPORT::"Transfer Shipment");
        InsertRepSelection(ReportSelections.Usage::Inv3, '1', REPORT::"Transfer Receipt");
        InsertRepSelection(ReportSelections.Usage::"Phys.Invt.Order", '1', REPORT::"Close Inventory Period - Test");
        // InsertRepSelection(Usage::"B.Stmt",'1',REPORT::"Bank Reconciliation");
        InsertRepSelection(ReportSelections.Usage::"B.Stmt", '1', REPORT::"Bank Account Statement");
        // InsertRepSelection(Usage::"B.Recon.Test",'1',REPORT::"Bank Rec. Test Report");
        InsertRepSelection(ReportSelections.Usage::"B.Recon.Test", '1', REPORT::"Bank Acc. Recon. - Test");
    ...
    begin
        ...
        InsertRepSelection(ReportSelections.Usage::"P.Blanket", '1', REPORT::"Purchase Blanket Order");
        InsertRepSelection(ReportSelections.Usage::"P.Order", '1', REPORT::"Purchase Order");
        InsertRepSelection(ReportSelections.Usage::"P.Invoice", '1', REPORT::"Purchase Invoice NA");
        InsertRepSelection(ReportSelections.Usage::"P.Return", '1', REPORT::"Return Order");
        InsertRepSelection(ReportSelections.Usage::"P.Cr.Memo", '1', REPORT::"Purchase Credit Memo NA");
        InsertRepSelection(ReportSelections.Usage::"P.Receipt", '1', REPORT::"Purchase Receipt NA");
        InsertRepSelection(ReportSelections.Usage::"P.Ret.Shpt.", '1', REPORT::"Return Shipment");
