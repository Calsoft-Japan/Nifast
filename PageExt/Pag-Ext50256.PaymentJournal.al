pageextension 50256 "Payment Journal Ext" extends "Payment Journal"
{
    ...
    BEGIN
        ...
        GenJnlLine.INIT();
        GenJnlLine."Journal Template Name" := VendUSDJnl."Journal Template Name";
        GenJnlLine."Journal Batch Name" := VendUSDJnl."Journal Batch Name";
        GenJnlLine."Line No." := VendUSDJnl."Line No." + 10;
        GenJnlLine."3-Way Line applied to" := VendUSDJnl."Line No.";
        ...
        GenJnlLine."Shortcut Dimension 1 Code" := VendUSDJnl."Shortcut Dimension 1 Code";
        GenJnlLine."Shortcut Dimension 2 Code" := VendUSDJnl."Shortcut Dimension 2 Code";
        GenJnlLine."Dimension Set ID" := VendUSDJnl."Dimension Set ID";
        GenJnlLine."Reason Code" := VendUSDJnl."Reason Code";
        GenJnlLine."Account Type" := GenJnlLine."Account Type"::Vendor;
        GenJnlLine."Account No." := VendUSDJnl."Account No.";
        ...
        IF (STRLEN(VendUSDJnl."External Document No.") + STRLEN(ExtDoc)) < 20 THEN
            GenJnlLine."External Document No." := VendUSDJnl."External Document No." + ' ' + ExtDoc
        ELSE
            GenJnlLine."External Document No." := VendUSDJnl."External Document No." + ' ' + COPYSTR(ExtDoc, 1, 19 - STRLEN(VendUSDJnl."External Document No."));
        //GenJnlLine."External Document No." := "External Document No.";

        GenJnlLine."Currency Code" := 'USD';
        GenJnlLine.Amount := -VendUSDJnl.Amount;
        GenJnlLine."Source Currency Code" := VendUSDJnl."Source Currency Code";
        GenJnlLine."Source Currency Amount" := VendUSDJnl."Source Currency Amount";
        GenJnlLine."Amount (LCY)" := -VendUSDJnl."Amount (LCY)";
        IF VendUSDJnl."Currency Code" = '' THEN
            GenJnlLine."Currency Factor" := 1
        ELSE
            GenJnlLine."Currency Factor" := VendUSDJnl."Currency Factor";
        GenJnlLine."Sales/Purch. (LCY)" := VendUSDJnl."Sales/Purch. (LCY)";
        GenJnlLine.Correction := VendUSDJnl.Correction;
        GenJnlLine."Inv. Discount (LCY)" := 0;
        GenJnlLine."Sell-to/Buy-from No." := VendUSDJnl."Sell-to/Buy-from No.";
        GenJnlLine."Bill-to/Pay-to No." := VendUSDJnl."Bill-to/Pay-to No.";
        GenJnlLine."Salespers./Purch. Code" := VendUSDJnl."Salespers./Purch. Code";
        GenJnlLine."System-Created Entry" := TRUE;
        GenJnlLine."On Hold" := VendUSDJnl."On Hold";
        GenJnlLine."Applies-to Doc. Type" := VendUSDJnl."Applies-to Doc. Type";
        GenJnlLine."Applies-to Doc. No." := VendUSDJnl."Applies-to Doc. No.";
        GenJnlLine."Applies-to ID" := VendUSDJnl."Applies-to ID";
        GenJnlLine."Allow Application" := VendUSDJnl."Bal. Account No." = '';
        GenJnlLine."Due Date" := VendUSDJnl."Due Date";
        GenJnlLine."Payment Terms Code" := VendUSDJnl."Payment Terms Code";
        GenJnlLine."Pmt. Discount Date" := VendUSDJnl."Pmt. Discount Date";
        GenJnlLine."Payment Discount %" := VendUSDJnl."Payment Discount %";
        GenJnlLine."Source Type" := GenJnlLine."Source Type"::Vendor;
        GenJnlLine."Source No." := VendUSDJnl."Source No.";
        GenJnlLine."Source Code" := VendUSDJnl."Source Code";
        GenJnlLine."Posting No. Series" := VendUSDJnl."Posting No. Series";
        GenJnlLine."IC Partner Code" := VendUSDJnl."IC Partner Code";
    ...
    BEGIN
        ...
        GenJnlLine."Journal Template Name" := VendUSDJnl."Journal Template Name";
        GenJnlLine."Journal Batch Name" := VendUSDJnl."Journal Batch Name";
        GenJnlLine."Line No." := VendUSDJnl."Line No." + 20;
        GenJnlLine."3-Way Line applied to" := VendUSDJnl."Line No.";
        ...
        GenJnlLine."Reason Code" := VendUSDJnl."Reason Code";
        GenJnlLine."Account Type" := GenJnlLine."Account Type"::Vendor;
        GenJnlLine.VALIDATE("Account No.", VendUSDJnl."Account No.");
    ...
    BEGIN
        ...
        IF GainLoss > 0 THEN BEGIN
            ...
            GenJnlLine."Line No." := VendUSDJnl."Line No." + 30;
            GenJnlLine."3-Way Line applied to" := VendUSDJnl."Line No.";
            GenJnlLine."Posting Date" := VendUSDJnl."Posting Date";
            GenJnlLine."Document Date" := VendUSDJnl."Document Date";
