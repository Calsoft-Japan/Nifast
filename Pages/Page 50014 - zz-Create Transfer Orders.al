page 50014 "zz-Create Transfer Orders"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater()
            {
                field(RcptLines.Select;RcptLines.Select)
                {
                }
                field(RcptLines."Document No.";RcptLines."Document No.")
                {
                    Editable = false;
                }
                field(RcptLines.Type;RcptLines.Type)
                {
                    Editable = false;
                }
                field(RcptLines."No.";RcptLines."No.")
                {
                    Editable = false;
                }
                field(RcptLines.Description;RcptLines.Description)
                {
                    Editable = false;
                }
                field(RcptLines."Location Code";RcptLines."Location Code")
                {
                    Editable = false;
                }
                field(RcptLines."Shortcut Dimension 1 Code";RcptLines."Shortcut Dimension 1 Code")
                {
                    Editable = false;
                }
                field(RcptLines."Responsibility Center";RcptLines."Responsibility Center")
                {
                    Editable = false;
                }
                field(RcptLines."Unit of Measure Code";RcptLines."Unit of Measure Code")
                {
                    Editable = false;
                }
                field(RcptLines.Quantity;RcptLines.Quantity)
                {
                    Editable = false;
                }
                field(RcptLines."Vessel Name";RcptLines."Vessel Name")
                {
                    Editable = false;
                }
                field(RcptLines."Sail-on Date";RcptLines."Sail-on Date")
                {
                    Editable = false;
                }
            }
    ...
    var
        RealRcptLines: Record "121";
        RcptLines: Record "121" temporary;
        Vend: Record "23";
        VendNo: Code[20];
