    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Flow Unit Cost"; Rec."Flow Unit Cost")
                {
                    ToolTip = 'Specifies the value of the Flow Unit Cost field.';
                    Caption = 'Flow Unit Cost';
                }
                field("Flow Vendor No."; Rec."Flow Vendor No.")
                {
                    ToolTip = 'Specifies the value of the Flow Vendor No. field.';
                    Caption = 'Flow Vendor No.';
                }
                ...
                field("Default Customer Bin Code"; Rec."Default Customer Bin Code")
                {
                    ToolTip = 'Specifies the value of the Default Customer Bin Code field.';
                    Caption = 'Default Customer Bin Code';
                }
                ...
                field("Blanket Orders"; Rec."Blanket Orders")
                {
                    ToolTip = 'Specifies the value of the Blanket Orders field.';
                ...
                field("ContractSelling Location Code"; Rec."ContractSelling Location Code")
                {
                    ToolTip = 'Specifies the value of the ContractSelling Location Code field.';
                    Caption = 'ContractSelling Location Code';
                }
