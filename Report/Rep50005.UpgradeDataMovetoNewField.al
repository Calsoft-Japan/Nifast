...
//                     repeat
//                         PurchRcptLine."Vendor Shipment No_Legacy" := PurchRcptLine."Vendor Shipment No.";
//                         PurchRcptLine.Modify();
//                     until PurchRcptLine.Next() = 0;
//                 SalesshipLine.Reset();
//                 SalesshipLine.SetFilter("External Document No.", '<>%1', '');
//                 if SalesshipLine.FindSet() then
//                     repeat
//                         SalesshipLine."External Document No_Legacy" := SalesshipLine."External Document No.";
