report 50018 "Item Age Comp. by Loc.- Value"
{
    // NF1.00:CIS.SP  08-28-15 Merged during upgrade
    // >>NF1
    ...
    // 07-01-05 RTT added functionality to mirror invt. valuation calc
    //          - new fcns
    //          - new var AsOfDate
    //          - Code at OnPreReport
    ...
    DefaultLayout = RDLC;
    RDLCLayout = '.\RDLC\Item Age Comp. by Loc.- Value.rdlc';

    Caption = 'Item Age Comp. by Loc.- Value';
    ...
    dataset
    {
        dataitem(Location; Location)
        {
            ...
            dataitem(Item; Item)
            {
                ...
                dataitem("Item Ledger Entry"; "Item Ledger Entry")
                {
                    ...
                    begin
                        ...
                        //>> NIF 020107
                        IF ShowACY THEN
                            TempItemLedgEntry."Qty. per Unit of Measure" := UnitCostACY
                        ELSE
                            TempItemLedgEntry."Qty. per Unit of Measure" := UnitCost;
            ...
            dataitem(ItemLoop; Integer)
            {
                ...
                column(InvtValue12_ItemLoop; InvtValue[1] + InvtValue[2])
                {
                }
                column(InvtValue3_ItemLoop; InvtValue[3])
                {
                    AutoFormatType = 1;
                }
                column(InvtValue4_ItemLoop; InvtValue[4])
                {
                    AutoFormatType = 1;
                }
                column(InvtValue5_ItemLoop; InvtValue[5])
                {
                    AutoFormatType = 1;
                }
                column(InvtValue6_ItemLoop; InvtValue[6])
                {
                    AutoFormatType = 1;
                }
                column(InvtValue7_ItemLoop; InvtValue[7])
                {
                    AutoFormatType = 1;
                }
                column(TotalInvtValue_ItemLoop; TotalInvtValue)
                {
                    AutoFormatType = 1;
                }
                dataitem(ItemLedgerLoop; Integer)
                {
                    ...
                    column(InvtValue12_ItemLedgerLoop; InvtValue[1] + InvtValue[2])
                    {
                    }
                    column(InvtValue3_ItemLedgerLoop; InvtValue[3])
                    {
                        AutoFormatType = 1;
                    }
                    column(InvtValue4_ItemLedgerLoop; InvtValue[4])
                    {
                        AutoFormatType = 1;
                    }
                    column(InvtValue5_ItemLedgerLoop; InvtValue[5])
                    {
                        AutoFormatType = 1;
                    }
                    column(InvtValue6_ItemLedgerLoop; InvtValue[6])
                    {
                        AutoFormatType = 1;
                    }
                    column(InvtValue7_ItemLedgerLoop; InvtValue[7])
                    {
                        AutoFormatType = 1;
                    }
                    column(TotalInvtValue_ItemLedgerLoop; TotalInvtValue)
                    {
                        AutoFormatType = 1;
                    }
                    ...
                    begin
                        ...
                        RemainingQty := TempItemLedgEntry."Remaining Quantity";
                        //>>NIF 020107
                        //  CalcUnitCost;

                        UnitCost := TempItemLedgEntry."Qty. per Unit of Measure";
                        UnitCostACY := TempItemLedgEntry."Qty. per Unit of Measure";
                        ...
                        LocTotalInvtValue := LocTotalInvtValue + TotalInvtValue;

                        FOR j := 1 TO 7 DO
                            LocInvtValue[j] := LocInvtValue[j] + InvtValue[j];

                        //>> NF1.00:CIS.SP 08-28-15
                        PrintLine := TRUE;
                ...
                begin
                    ValuesExist := ((InvtValue[1] <> 0) OR (InvtValue[2] <> 0) OR (InvtValue[3] <> 0) OR (InvtValue[4] <> 0) OR
                                           (InvtValue[5] <> 0) OR (InvtValue[6] <> 0) OR (InvtValue[7] <> 0) OR (TotalInvtValue <> 0));
    ...
    labels
    {
        ItemAgeCompositionValueCaption = 'Item Age Comp. by Loc.- Value';
    ...
    trigger OnPreReport()
    var
        NegPeriodLength: array[8] of DateFormula;
    begin
        ...
        PeriodStartDate[8] := 18991231D;//12311899D; BC Upgrade. 2025-06-23
        PeriodStartDate[1] := 99991231D;//12319999D; BC Upgrade. 2025-06-23
        IF PeriodStartDate[2] = 0D THEN
        ...
        IF ExportToExcel THEN BEGIN
            ...
            MakeExcelInfo; //NF1.00:CIS.SP 08-28-15
        END;
        //<< NIF RTT 11-02-05
    ...
    var
        ...
        ValuesExist: Boolean;
        LocTotalInvtValue: Decimal;
        LocInvtValue: array[8] of Decimal;
        j: Integer;
        ...
        Text012: Label 'Item Age Comp. by Loc.- Value';
        ...
        ExcelTotalInvtValue12: Decimal;
        ExcelTotalInvtValue3: Decimal;
        ExcelTotalInvtValue4: Decimal;
        ExcelTotalInvtValue5: Decimal;
        ExcelTotalInvtValue6: Decimal;
        ExcelTotalInvtValue7: Decimal;
        ExcelTotalInvtValueTotal: Decimal;
    ...
    begin
        ...
        IF ValuedQty <> 0 THEN BEGIN
            ...
            //SM001 1/23/18 update
            //UnitCostACY := InvoicedValueACY/ValuedQty;//(InvoicedValueACY+ExpectedValueACY)/ValuedQty;
    ...
    begin
        ...
        ExcelBuf.AddInfoColumn(REPORT::"Item Age Comp. by Loc.- Value", FALSE, FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.NewRow;
    ...
    begin
        //>> NF1.00:CIS.SP 08-28-15
        ExcelTotalInvtValue12 += ExcelItemWiseTotalInvtValue12;
        ExcelTotalInvtValue3 += ExcelItemWiseTotalInvtValue3;
        ExcelTotalInvtValue4 += ExcelItemWiseTotalInvtValue4;
        ExcelTotalInvtValue5 += ExcelItemWiseTotalInvtValue5;
        ExcelTotalInvtValue6 += ExcelItemWiseTotalInvtValue6;
        ExcelTotalInvtValue7 += ExcelItemWiseTotalInvtValue7;
        ExcelTotalInvtValueTotal += ExcelItemWiseTotalInvtValueTotal;
    ...
    begin
        //>> NF1.00:CIS.SP 08-28-15
        ExcelTotalInvtValue12 += InvtValue[1] + InvtValue[2];
        ExcelTotalInvtValue3 += InvtValue[3];
        ExcelTotalInvtValue4 += InvtValue[4];
        ExcelTotalInvtValue5 += InvtValue[5];
        ExcelTotalInvtValue6 += InvtValue[6];
        ExcelTotalInvtValue7 += InvtValue[7];
        ExcelTotalInvtValueTotal += TotalInvtValue;
    ...
    begin
        ...
        IF PrintDetail THEN BEGIN
            ...
            ExcelBuf.AddColumn('', FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
        END;
        ExcelBuf.AddColumn(Location.Code + Text023, FALSE, '', TRUE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.AddColumn(ExcelTotalInvtValue12, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(ExcelTotalInvtValue3, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(ExcelTotalInvtValue4, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(ExcelTotalInvtValue5, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(ExcelTotalInvtValue6, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(ExcelTotalInvtValue7, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(ExcelTotalInvtValueTotal, FALSE, '', TRUE, FALSE, FALSE, '#,##0.00', ExcelBuf."Cell Type"::Number);
        ExcelBuf.NewRow;

        ExcelGrandTotalInvtValue12 += ExcelTotalInvtValue12;
        ExcelGrandTotalInvtValue3 += ExcelTotalInvtValue3;
        ExcelGrandTotalInvtValue4 += ExcelTotalInvtValue4;
        ExcelGrandTotalInvtValue5 += ExcelTotalInvtValue5;
        ExcelGrandTotalInvtValue6 += ExcelTotalInvtValue6;
        ExcelGrandTotalInvtValue7 += ExcelTotalInvtValue7;
        ExcelGrandTotalInvtValueTotal += ExcelTotalInvtValueTotal;
        //<< NF1.00:CIS.SP 08-28-15
    end;
    ...
    begin
        //>> NF1.00:CIS.SP 08-28-15
        ExcelTotalInvtValue12 := 0;
        ExcelTotalInvtValue3 := 0;
        ExcelTotalInvtValue4 := 0;
        ExcelTotalInvtValue5 := 0;
        ExcelTotalInvtValue6 := 0;
        ExcelTotalInvtValue7 := 0;
        ExcelTotalInvtValueTotal := 0;
