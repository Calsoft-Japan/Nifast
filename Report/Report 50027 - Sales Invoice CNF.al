report 50027 "Sales Invoice CNF"
{
    // NF1.00:CIS.NG 08-28-15 Merged during upgrade
    ...
    //                        new var TotalLabel to show currency amounts
    //                        -code at "Sales Invoice Header"-OnAfterGetRecord to assign
    //                        -added at bottom in place of Total caption
    // 02/14/06 RTT           code at SalesInvLine-OnAfterGetRecord() to use unit price if no discount
    // << NIF
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = '.\RDLC\Sales Invoice CNF.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(SalesInvLine; Integer)
                    {
                        ...
                        column(CrossReferernceNo; 'Cross Referernce No.: ' + TempSalesInvoiceLine."Item Reference No.")//"Cross-Reference No." BC Upgrade 2025-06-24
                        {
                        }
                        column(TempSalesInvoiceLine_CrossReferenceNo; TempSalesInvoiceLine."Item Reference No.")//"Cross-Reference No." BC Upgrade 2025-06-24
                        {
                        }
                        column(RevisionText; RevisionText)
                        {
                        }
                        column(TempSalesInvoiceLine_RevisionText; TempSalesInvoiceLine."Revision No.")
                        {
                        }
                        ...
                        column(GSTNoCaption; GSTNoCaptionLbl)
                        {
                        }
                        ...
                        begin
                            ...
                            ELSE
                                ...
                                ELSE BEGIN
                                    ShipmentLine.SETRANGE(ShipmentLine."Order No.", "Sales Invoice Header"."Order No.");
                                    ShipmentLine.SETRANGE(ShipmentLine."Order Line No.", TempSalesInvoiceLine."Line No.");
            ...
            begin
                ...
                //>> NIF 07-14-05
                TotalLabel := 'Total ' + "Currency Code" + ':';
                //<< NIF 07-14-05
    ...
    trigger OnPreReport()
    begin
        ShipmentLine.SETCURRENTKEY(ShipmentLine."Order No.", ShipmentLine."Order Line No.");
    ...
    var
        ...
        AmountExemptfromSalesTaxCaptionLbl: Label 'Amount Exempt from GST Tax';
        ...
        GSTNoCaptionLbl: Label 'GST No.:';

    procedure InitLogInteraction()
    begin
        LogInteraction := SegManagement.FindInteractionTemplateCode("Interaction Log Entry Document Type"::"Sales Inv.") <> ''; //SegManagement.FindInteractTmplCode(4) <> ''; BC Upgrade 2025-06-24
    end;
