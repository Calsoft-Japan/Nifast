report 50032 "Sales Shpt. Packing List - CNF"
{
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem("Posted Package"; "LAX Posted Package")//Table14000704) BC Upgrade 2025-06-24
            {
                ...
                dataitem(DataItem4761; "LAX Posted Package Line")//Table14000705) BC Upgrade 2025-06-24
                {
    ...
    var
        ...
        PackingRule: Record "LAX Packing Rule";//"14000715";
        ASNCaption: Text[30];
        ASNValue: Code[20];
