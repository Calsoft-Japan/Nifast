...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Inventory Valuation NIF.rdlc';
    ...
    dataset
    {
        dataitem(DataItem8129;Table27)
        {
            ...
            dataitem(BufferLoop;Table2000000026)
            {
    ...
    var
        ...
        TempEntryBuffer: Record "10139" temporary;
    ...
    procedure UpdateBuffer(var ItemLedgEntry: Record "32")
    var
        NewRow: Boolean;
    begin
