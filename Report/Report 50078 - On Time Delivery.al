report 50078 "On Time Delivery"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './On Time Delivery.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000000;Table23)
        {
            ...
            dataitem(DataItem1000000001;Table120)
            {
                ...
                dataitem(DataItem1000000002;Table121)
                {
    ...
    var
        SalesInvoiceHeader_lRec: Record "112";
        SalesCrMemoHeader_lRec: Record "114";
        ServiceInvoiceHeader_lRec: Record "5992";
        ServiceCrMemoHeader_lRec: Record "5994";
    ...
    begin
        ExcelBuf.CreateBookAndOpenExcel(Text012,Text011,COMPANYNAME,USERID);
        ERROR('');
    end;
}
