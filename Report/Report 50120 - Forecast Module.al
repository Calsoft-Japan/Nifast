report 50120 "Forecast Module"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Forecast Module.rdlc';
    ...
    dataset
    {
        dataitem(DataItem8129;Table27)
        {
            ...
            dataitem(DataItem9388;Table5722)
            {
            ...
            dataitem(DataItem6766;Table50027)
            {
            ...
            dataitem(PurchOrderLoop;Table2000000026)
            {
            ...
            dataitem(SalesOrderLoop;Table2000000026)
            {
                DataItemTableView = SORTING(Number);
                PrintOnlyIfDetail = false;
            ...
            dataitem(DataItem6631;Table50029)
            {
                DataItemLink = Item No.=FIELD(No.);
            ...
            begin
                ...
                IF i = 1 THEN BEGIN
                    ...
                    ItemLedgerEntry.SETCURRENTKEY("Entry Type","Item No.","Variant Code","Drop Shipment",
                                                  "Global Dimension 1 Code","Global Dimension 2 Code","Location Code","Posting Date","QC Hold");
    ...
    begin
        IF ExportToExcel THEN
          BEGIN
            ...
            ExcelBuf_gRecTmp.CreateBookAndOpenExcel(MainTitle,MainTitle,COMPANYNAME,USERID);
            ERROR('');
          END;
    end;
    ...
    begin
        ...
        //Canada portion
        PeriodStartingDate[78] := 12309999D;
    ...
    var
        ...
        DailyUsage: Decimal;
        DaysSupply: Integer;
        DelSchedBatch: Record "50020";
        DelSchedHdr: Record "50012";
        DelSchedLine: Record "50013";
        j: Integer;
        LinesFound: Boolean;
        ...
        ForecastLedgerEntry: Record "50027";
        ...
        ForecastLedgEntry: Record "50027";
        ...
        ExcelBuf_gRecTmp: Record "370" temporary;
        ...
        PurchLine_gRec: Record "39";
        SalesLine_gRec: Record "37";
    ...
    procedure AdjustItemLedgEntryToAsOfDate(var ItemLedgEntry: Record "32")
    var
    ...
    var
        ForecastLedgEntry_lRec: Record "50027";
