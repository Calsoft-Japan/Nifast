table 50016 "Ship Authorization Line"
{
    fields
    {
        ...
        field(7; "Cross-Reference Type No."; Code[30])
        {
            ...
            var
                ...
                ItemFilters: Text;
            begin
                ItemCrossReference.SETRANGE("Reference Type", "Cross-Reference Type");
                ItemCrossReference.SETRANGE("Reference No.", "Cross-Reference No.");
                ItemCrossReference.SETRANGE("Reference Type No.", "Cross-Reference Type No.");
                IF ItemCrossReference.FIND('-') THEN
                    VALIDATE("Item No.", ItemCrossReference."Item No.")
                else begin
                    ItemFilters := ItemCrossReference.GETFILTERS();
                    ErrMsg := 'Item not found for Item Cross Reference ' + ItemFilters;
                    Error(ErrMsg);
                end;
            end;
        }
    ...
    keys
    {
        key(Key1; "Sell-to Customer No.", "Document No.", "Line No.")
        {
        }
    }
