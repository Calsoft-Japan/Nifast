tableextension 50032 "Item Ledger Entry Ext" extends "Item Ledger Entry"
{
    fields
    {
        ...
        field(70001; "Contract No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
        ...
        field(70003; "Customer Bin"; tEXT[12])
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
        field(70004; "Rework No"; cODE[20])
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
        ...
        field(70006; "No Cr. Mgmt. Comment"; Boolean)
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
            Editable = false;
        ...
        field(70009; "FB Order No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
        field(70010; "FB Line No."; Integer)
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
        field(70011; "FB Tag No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
        field(70012; "FB Customer Bin"; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'NV';
        }
